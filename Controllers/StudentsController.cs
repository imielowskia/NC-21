...
namespace NC_21.Controllers
{
    public class StudentsController : Controller
    {
        ...
        public StudentsController(NC_21Context context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("Id,Imie,Nazwisko,Album,Data_start,GroupId")] Student student)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Imie,Nazwisko,Album,Data_start,GroupId")] Student student)
        {
            if (id != student.Id)
            {
                return NotFound();
